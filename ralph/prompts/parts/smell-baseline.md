...
licence, © 2026 Matt Pocock. The catalogue below is copied as it stands; the
process around it is this repo's own.
-->

On top of whatever this repo documents, the Standards axis always carries the
**smell baseline** below — a fixed set of Fowler code smells (_Refactoring_,
ch.3) that applies even where a repo documents nothing. Two rules bind it:
