...
VALUES ('implementing-value-objects-in-nodejs', 'en', 'post', 'Implementing Value Objects in Node.js', 'A practical guide to implementing Value Objects in TypeScript and Node.js to create more robust and expressive domain models, inspired by Domain-Driven Design principles.', '2025-11-02', '["nodejs","typescript","ddd","architecture","value-object"]', 'https://github.com/poschuler/nodejs-ddd-value-objects', '[]', NULL, NULL, NULL, CURRENT_TIMESTAMP);
