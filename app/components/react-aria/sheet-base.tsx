...
//const SheetPortal = Dialog;

const SheetOverlay = React.forwardRef<
  React.ElementRef<typeof ModalOverlay>,
...
SheetOverlay.displayName = ModalOverlay.name;
...
SheetContent.displayName = Modal.name;
...
SheetTitle.displayName = Heading.name;
