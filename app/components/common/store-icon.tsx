  ...
  return (
    <>
      {name === PLAZA_VEA && (
        ...
        >
          <PlazaVeaIconSmall className="h-3 w-3" />
          {isBestPrice && (
      ...
      {name === METRO && (
        <div className="bg-yellow-400-600 opacity-90 relative">
          <MetroIconSmall className="h-[20px] w-[20px]" />
          {isBestPrice && (
      ...
      {name === TOTTUS && (
        <div className="bg-white opacity-90 rounded-full relative">
          <TottusIconSmall className="h-[14px] w-[14px]" />
          {isBestPrice && (
      ...
      {name === VIVANDA && (
        <div className="bg-white opacity-90 rounded-full relative">
          <VivandaIconSmall className="h-3 w-3" />
          {isBestPrice && (
            <Sparkles className="absolute size-5 -bottom-[4px] -right-[4px] fill-yellow-400 stroke-1 stroke-yellow-400" />
          )}
        </div>
      ...
      {name === WONG && (
        <div className="bg-yellow-400-600 opacity-90 relative">
          <WongIconSmall className="h-[20px] w-[20px]" />
          {isBestPrice && (
...
type StoreIconCardLink2Props = {
  name: string;
  isBestPrice: boolean;
};

export function StoreIconCardLink2({
  name,
  isBestPrice = false,
}: StoreIconCardLink2Props) {
  return (
    <>
      {name === PLAZA_VEA && (
        <div
