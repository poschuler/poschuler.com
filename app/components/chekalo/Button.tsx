...
const variantClassNames: Record<ButtonVariant, string> = {
  ...
  secondary:
    "data-[focus-visible]:ring-default text border border-default bg-transparent data-[hovered]:bg-hover data-[hovered]:border-hover",
  destructive:
  ...
  link:
    "text-low border-transparent bg-transparent data-[hovered]:text-default hover:text-default",
};
...
export function getButtonClassName(options: ButtonOptions) {
  ...
  return clsx(
    ...
    "align-center data-[disabled]:opacity-disabled inline-flex select-none whitespace-nowrap border border-default font-sans font-medium transition data-[disabled]:cursor-default",
  );
}
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, ...props }, ref) => {
    ...
    return (
      <RACButton
        ref={ref}
        className={clsx(buttonClassName, "cursor-pointer", className)}
        {...props}
      />
    );
  },
