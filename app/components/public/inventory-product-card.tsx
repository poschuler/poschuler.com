...
import { type InventoryProduct } from "~/features/master-products_old/domain/InventoryMasterProduct";
  ...
  return (
    <Popover>
      <PopoverTrigger>
        <div
          className={clsx(
            "p-2 gap-2 border border-default rounded-lg w-full h-full flex transition-all duration-500  items-center justify-between leading-none hover:scale-105 shadow",
        ...
        >
          ...
          <p className="font-semibold text-sm font-quicksand">
            S/. {inventoryProduct.best_price}
          </p>
        </div>
      </PopoverTrigger>
