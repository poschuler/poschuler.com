 ...
 * screen-reader-only label naming the network.
 */
...
/** Renders the mark for a network name, or nothing for an unknown one. */
export function BrandNetworkIcon({
  network,
  ...props
}: BrandIconProps & { network: string }) {
  const Icon = brandIcons[network as BrandNetwork];
