...
import { LoaderData } from "~/routes/layouts/app/_app";

const LazyProduct = lazy(() => import("~/components/app/product-card").then((module) => ({ default: module.ProductCard })));
...
export default function Swiper({ products, index }: SwiperProps) {
    ...
    const appLoaderData = useTypedRouteLoaderData<LoaderData>("routes/layouts/app/_app");
    const shoppingLists = appLoaderData ? appLoaderData.shoppingLists : [];
