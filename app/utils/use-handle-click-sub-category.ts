...
export function useHandleClickSubCategory(
  ...
  return function submit() {
    ...
    navigate(
      `/departamento/${eventObject.departmentNameSlug}/categoria/${eventObject.categoryNameSlug}/subcategoria/${eventObject.subCategoryNameSlug}`
    );
  };
}
