...
If this repo ever splits into multiple bounded contexts, switch to the multi-context layout: a `CONTEXT-MAP.md` at the root pointing at one `CONTEXT.md` per context, with context-scoped `docs/adr/` alongside each. Update this file when that happens.
